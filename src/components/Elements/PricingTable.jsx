...
export default function PricingTable({ icon, price, title, text, actionText , offers, action }) {
  



  return (
    <Wrapper className="whiteBg pricing radius8 shadow">
      ...
      <div style={{ maxWidth: "220px", margin: "30px auto 0 auto" }}>
       <a href ={action}><FullButton title={actionText}/></a>
      </div>
    </Wrapper>
  );
}
