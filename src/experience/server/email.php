...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Verify Your Email</title>
...
<head>
  ...
  <style type="text/css">
    ...
    */
    ...
    @tip Set the background color and border for your email header area.
    @theme header
    */
      #templateHeader{
    ...
    */
    ...
    @tab Body
    @section body text
    @tip Set the styling for your email main content text. Choose a size and color that is easy to read.
    @theme main
    */
      .bodyContent div{
        /*@editable*/color:#505050;
    ...
    */
    ...
    @tab Footer
    @section social bar style
    @tip Set the background color and border for your emai  footer social bar.
    */
      #social div{
        /*@editable*/text-align:left;
      }
    ...
    @tip Set the background color and border for your emai  footer utility bar.
    @theme footer
    */
      #utility{
        /*@editable*/background-color:#FFFFFF;
                  ...
                  <tr>
                    <td valign="top" style="border-collapse:collapse;">
                      <!-- <div mc:edit="std_preheader_content">
                                                     Use this area to offer a short teaser of your emai  content. Text here will show in the preview area of some email clients.
                                                  </div>
                                                  -->
                    </td>
                  </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="450" id="templateHeader" style="background-color:#FFFFFF;border-bottom:0;">
                  <tr>
                    <td class="headerContent centeredWithBackground" style="border-collapse:collapse;color:#202020;font-family:Arial;font-size:34px;font-weight:bold;line-height:100%;padding:0;text-align:center;vertical-align:middle;background-color:#F4EEE2;padding-bottom:20px;padding-top:20px;">
                      ...
                      <img width="130" src="https://ni-experiences.com/logow.png" style="width:130px;max-width:130px;border:0;height:auto;line-height:100%;outline:none;text-decoration:none;" id="headerImage campaign-icon">
                        ...
                        <tr>
                          <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                            <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                              <h1 class="h1" style="color:#202020;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;">Verify Your Account</h1>


                              <p>Hello '.$name.',<br> Welcome to the n Industry Experience. verify your account using the activation code below .</p>
                            </div>
                          </td>
                        </tr>
                        <tr>
                              ...
                              <tbody>
                                <tr align="center">
                                  <td align="center" valign="middle" style="border-collapse:collapse;">
                                    <span class="buttonText" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">'.$code.'</span>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                          ...
                          <td valign="top" width="100%" style="border-collapse:collapse;">
                            ...
                            <div style="text-align: center; color: #c9c9c9;">
                              <p>Questions? Get your answers here:&nbsp;
                                <a href="https://ni-experiences.com/faqs" style="color:#4a90e2;font-weight:normal;text-decoration:underline; font-size: 12px;">Help Center</a>.</p>
                            </div>
                            <br>
                          </td>
                        </tr>
